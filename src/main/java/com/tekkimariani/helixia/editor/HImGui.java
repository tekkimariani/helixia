...
public class HImGui {
	...
	private static float resetValue = 0.0f;
	private static float columnWidth = 110.0f;
	

	public static void drawVec2Control(String label, Vector2f values) {
		HImGui.drawVec2Control(label, values, resetValue, columnWidth);
	}
    ...
    public static void drawVec3Control(String label, Vector3f values) {
        drawVec3Control(label, values, 0.0f, columnWidth);
    }

    public static void drawVec3Control(String label, Vector3f values, float resetValue) {
        drawVec3Control(label, values, resetValue, columnWidth);
    }
